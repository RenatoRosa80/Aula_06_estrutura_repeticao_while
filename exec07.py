...
#Menor número
if num1 < num2 and num1 < num3:
    print(" O Número 1 é o menor dos 3 números informados! ")
elif num2 < num1 and num2 < num3:
    print(" O Número 2 é o menor dos 3 números informados! ")
elif num3 < num1 and num3 < num2:
    print(" O Número 3 é o menor dos 3 números informados! ")
else:
    print(" Good job! ")
